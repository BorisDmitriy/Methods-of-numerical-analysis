...
namespace metod.Lab_8
{
	public partial class Form1 : Form
	{
		public Form1()
		{
            ...
            chart1.Series.Add("Параболическая интерполяция сплайна");
            ...
            ParabSpline ps = new ParabSpline();
			
			for ( var x = MasX[0] ; x <= MasX[MasX.Length-1]; x += 0.001)
			{
				X.Add(x);
                Y.Add(ps.build_spline_and_interpolate(x, MasX, MasY));
            }
